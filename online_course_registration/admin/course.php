...
<body class="myprofile">
  <nav>
    ...
    <div class="wrapper">
                     ...
                     <div class="form">
                          <form name="dept" method="post">
                               <div class="inputfield">
                                  ...
                                  <input type="text" class="input" id="coursecode" name="coursecode" placeholder="Course Code" required />
                               </div>  
                                    <div class="inputfield">
                                        <label for="coursename">Course Name  </label>
                                        <input type="text" class="input" id="coursename" name="coursename" placeholder="Course Name" required />
                                     </div>  
                                         <div class="inputfield">
                                            <label for="courseunit">Course unit  </label>
                                            <input type="number" class="input" id="courseunit" name="courseunit" placeholder="Course Unit" required />
                                          </div>   
                                               <div class="inputfield">
                                                    <label for="seatlimit">Seat limit  </label>
                                                    <input type="number" class="input" id="seatlimit" name="seatlimit" placeholder="Seat limit" required />
                                               </div> 
      ...
      <h1>MANAGE COURSE</h1>
      <font color="red" align="center"><?php if (isset($_SESSION['msg'])) { echo htmlentities($_SESSION['msg']);}?></font>
...
<button class="btn btn-primary"><i class="fa fa-edit "></i> Edit</br></button> </a>                                    
