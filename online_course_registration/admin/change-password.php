...
<div class="container">
  <div class="login-content">
    <form name="chngpwd" method="post" onSubmit="return valid();">
        ...
        <h2 class="title">ADMIN CHANGE PASSWORD</h2></br>
        <font color="green" align="center">
          ...
          <div class="input-div one"></br>
            <div class="div">
                ...
                <input type="password" class="input" id="exampleInputPassword1" name="cpass"  />
          ...
          <div class="input-div pass"></br>
            <div class="div">
                <h5>New password</h5>
                <input type="password" class="input" id="exampleInputPassword2" name="newpass" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters"/>
							  <i class="toggle-password fa fa-fw fa-eye-slash"></i> 
            </div>
          </div>
          <div class="input-div pass"></br>
            <div class="div">
              ...
              <input type="password" class="input" id="exampleInputPassword3" name="cnfpass"  />
              <i class="toggle-password fa fa-fw fa-eye-slash"></i>
            </div>
          </div>
